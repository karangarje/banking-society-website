...
export default function PhotoGallery() {
  ...
  const [dynamicPhotos, setDynamicPhotos] = useState<GalleryItem[]>([]);
  ...
  const galleryItems = dynamicPhotos.length > 0 ? dynamicPhotos : defaultGalleryItems;
          ...
          {filteredItems.map((photo) => (
            ...
            >
              ...
              <div className="p-4 space-y-1.5">
                ...
                <h3 className="text-base font-bold text-text-main group-hover:text-[#AD002E] transition-colors mt-2 line-clamp-1">
                  {isMr ? photo.titleMr : photo.title}
                </h3>
                <p className="text-sm text-text-muted line-clamp-2 leading-relaxed transition-colors">
