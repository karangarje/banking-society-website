  ...
  return (
    <section className="mt-12 bg-white rounded-lg shadow-md border border-[#AD002E] p-6" data-aos="fade-up">
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <button className="flex-1 flex items-center justify-center gap-2 !bg-[#B3003C] !text-white hover:!bg-[#990033] hover:!text-white active:!text-white focus:!text-white py-2 rounded-lg transition">
          <PhoneOutlined className="!text-white" /> <span className="!text-white">Call Us</span>
        </button>
