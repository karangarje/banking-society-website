        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
          {branchesData.map((branch, index) => (
            <button
              ...
              className="group flex flex-col items-center justify-center p-6 rounded-2xl bg-base-card border border-[rgba(0,0,0,0.04)] hover:border-[rgba(173,0,46,0.2)] transition-all duration-400 shadow-sm hover:shadow-[0_12px_30px_-8px_rgba(173,0,46,0.12)] hover:-translate-y-1 cursor-pointer text-center"
            >
              {/* Icon */}
              ...
              {branch.isHeadOffice && (
                <span className="text-xs bg-[#AD002E] text-white px-2 py-0.5 rounded-full font-extrabold uppercase mt-2 tracking-widest border border-[#850024]">
            ...
            <div className="space-y-6 text-base">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    <h5 className={`font-bold transition-colors ${isDark ? "text-gray-600" : "text-gray-700"}`}>{t("branches_sect.email_address")}</h5>
                    <a href={`mailto:${selectedBranch.email}`} className={`transition-colors mt-1 block ${isDark ? "text-gray-600 hover:text-[#AD002E]" : "text-gray-600 hover:text-[#AD002E]"}`}>
