export interface ServiceDetail {
  ...
  shortDesc: string;
  icon: string;
  category: "shares" | "deposits" | "loans" | "digital" | "vault";
  interestRate?: string;
  features: string[];
  eligibility: string[];
  documents: string[];
...
export const servicesData: ServiceDetail[] = [
  {
    id: "member-shares",
    title: "Member Shares Capital",
    shortDesc: "Become a shareholder and active part-owner of our financial co-operative society to enjoy dividend distributions.",
    icon: "TeamOutlined",
    category: "shares",
    interestRate: "Up to 15% Dividend (Annual)",
    features: [
      "Voting rights in the Annual General Body Meetings (AGM).",
      "Annual dividend distributions based on financial surplus.",
      "Transferable share units conforming to state co-op guidelines.",
      "Access to exclusive loan and financial schemes for active members.",
    ],
    eligibility: [
      "Must be a citizen of India residing within our operational area.",
      "Minimum age of 18 years (parents/guardians can apply for minors).",
      "Must purchase at least 10 shares of face value ₹100 each.",
      "Subject to approval by the Board of Directors.",
    ],
    documents: [
      "Completed Membership Application Form.",
      "Proof of Identity (Aadhaar Card, PAN Card, Voter ID).",
      "Proof of Address (Electricity bill, Passport, Rent Agreement).",
